...
class SerialBuilderTest {
    ...
    private static class ExternalizableWithSerializableSuperClass extends SimpleSerializableClass implements Externalizable {
        @Serial
        private static final long serialVersionUID = 1L;

        public ExternalizableWithSerializableSuperClass() {
            this(1);
        }

        public ExternalizableWithSerializableSuperClass(int i) {
            super(i);
        }
    ...
    @Test
    void externalizableWithSerializableSuperClass() {
        byte[] actualData = SerialBuilder.startExternalizableObject()
            .beginDescriptorHierarchy()
                .beginDescriptor()
                    .type(ExternalizableWithSerializableSuperClass.class)
                    .uid(ExternalizableWithSerializableSuperClass.serialVersionUID)
                    .flags(SC_EXTERNALIZABLE | SC_BLOCK_DATA)
                .endDescriptor()
                .beginDescriptor()
                    .type(SimpleSerializableClass.class)
        ...
        byte[] expectedData = serialize(new ExternalizableWithSerializableSuperClass(10));
        assertArrayEquals(expectedData, actualData);
    }
